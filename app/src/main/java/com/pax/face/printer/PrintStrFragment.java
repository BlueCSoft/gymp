...
public class PrintStrFragment extends BaseActivity implements OnClickListener {
    ...
    protected int getLayoutId(){
        return R.layout.fragment_printer_printstr;
    }

    //初始化视图
    @Override
    protected void initView() {
        asciiSpinner = (Spinner) findViewById(R.id.fragment_printer_spinner_ascii);
        extCodeSpinner = (Spinner) findViewById(R.id.fragment_printer_spinner_extcode);

        addBitMapBt = (Button) findViewById(R.id.fragment_printer_bitmap);
        doubleWidthBt = (Button) findViewById(R.id.fragment_printer_doublewidth_bt);
        doubleHeightBt = (Button) findViewById(R.id.fragment_printer_doubleheight_bt);
        invertBt = (Button) findViewById(R.id.fragment_printer_invert_bt);
        getStatusBt = (Button) findViewById(R.id.fragment_printer_status_bt);
        getDotLineBt = (Button) findViewById(R.id.fragment_printer_getdotline_bt);
        startBt = (Button) findViewById(R.id.fragment_printer_start);
        ...
        wordSpaceEt = (EditText) findViewById(R.id.fragment_printer_spaceset_word_et);
        lineSpaceEt = (EditText) findViewById(R.id.fragment_printer_spaceset_line_et);
        leftIndentEt = (EditText) findViewById(R.id.fragment_printer_leftindent_et);
        setGrayEt = (EditText) findViewById(R.id.fragment_printer_setgray_et);
        stepEt = (EditText) findViewById(R.id.fragment_printer_step_et);
        printStrEt = (EditText) findViewById(R.id.fragment_printer_prnstr_et);
        statusTv = (TextView) findViewById(R.id.fragment_printer_status_tv);
        getDotLineTv = (TextView) findViewById(R.id.fragment_printer_getdotline_tv);

        ArrayAdapter<EFontTypeAscii> asciiAdapter = new ArrayAdapter<EFontTypeAscii>(this,
                android.R.layout.simple_spinner_item, EFontTypeAscii.values());
        asciiSpinner.setAdapter(asciiAdapter);
        ArrayAdapter<EFontTypeExtCode> extCodeAdapter = new ArrayAdapter<EFontTypeExtCode>(this,
